...
// ADD TO RETURNS HERE TO ACCOMODATE FOR IMAGE CHANGE
...
// Reducer that checks the location of given point (x,y) with respect to element
...
// Adjusts for Line and Rectangle
...
function Whiteboard() {
  ...
  const handleUrlChange = (e) => {
    console.log("URLVALUE2", e.target.value);
    testImgUrl = e.target.value;
    setImgUrl(e.target.value);
  };

  //WAS LAST MESSING AROUND WITH SETTING THE URL OF STATE AND APPLYING IT TO CODE BELOW
  //FOR testImg. Lookat Chat cmponent to reset handle funcs abve and below
  //before that run console logs to check the state f state

  const handleUrlSubmit = (e) => {
    e.preventDefault();
    console.log("URLVALUE", e.target.value);
  ...
  // let testImgUrl =
  //   "http://cdn.lightgalleries.net/4bd5ec004b324/images/PvA_W_DN911_004-1.jpg";
  let testImgUrl =
  'https://content.magnumphotos.com/wp-content/uploads/2017/12/cortex/nyc28135-overlay.jpg'
  ...
  useLayoutEffect(() => {
    ...
    elements.forEach((element) => {
      ...
      const testImg = new Image();
      testImg.src = testImgUrl;
      console.log("TEST_IMG", testImg.src);
      context.drawImage(testImg, 0, 0, canvas.width, canvas.height / 2);
  ...
  //   const testImg = new Image();
  //   const testImgUrl = "https://artblart.files.wordpress.com/2012/09/winogrand-web.jpg"
  //   testImg.src = testImgUrl;
  ...
  return (
    <div id="whiteboard">
      <div id="boardContainer">
        ...
        <form onSubmit={handleUrlSubmit} id="urlSubmit">
          <div>
            <TextField
              name="imgUrl"
      ...
      <div id="generalToolbar">
        ...
        <div id="whiteboardToolbar">
          ...
          <div id="buttons">
            ...
            <button id="clearBtn" onClick={clearScreen}>
              Clear Screen
            </button>
          </div>
        </div>
